...
Създайте полиморфна йерархия от геометрични фигури с абстрактен клас `Shape`, който има следните методи:
- `getPerimeter`
- `getArea`
- `isPointInside`

Ще поддържаме следните фигури, като помислете за подходящо представяне на данните: `Triangle`, `Rectangle` и `Circle`
...
## Задача 3
Създайте проста йерархия, описваща потребители, логващи се като играчи.
...
## Задача 4 
Ще реализираме йерархия, описваща награди, които нашия потребител може да си купи. 
